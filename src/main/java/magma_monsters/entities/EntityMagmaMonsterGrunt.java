...
public class EntityMagmaMonsterGrunt extends MonsterEntity {
	...
	protected void registerAttributes() {
		...
		getAttribute(SharedMonsterAttributes.ATTACK_DAMAGE).setBaseValue(Config.MAGMA_MONSTER_GRUNT_ATTACK_DAMAGE.get());
		...
		getAttribute(SharedMonsterAttributes.MAX_HEALTH).setBaseValue(Config.MAGMA_MONSTER_GRUNT_HEALTH.get());
	}
	...
	public static boolean canSpawnHere(EntityType<EntityMagmaMonsterGrunt> entity, IWorld world, SpawnReason spawn_reason, BlockPos pos, Random random) {
		return true;//getCanSpawnNearLava() && pos.getY() <= ConfigHandler.MAGMA_SPAWN_Y_HEIGHT.get();
	}
