...
public class Config {
    ...
    static {
		...
		MAGMA_MONSTER_OW_SPAWN_PROBABILITY = COMMON_BUILDER.comment("Over World Magma Monster Chance Probability").defineInRange("magma_monster_chance", 2000, 1, Integer.MAX_VALUE);
		...
		MAGMA_MONSTER_HELL_SPAWN_PROBABILITY = COMMON_BUILDER.comment("Nether Magma Monster Chance Probability").defineInRange("magma_monster_chance", 2000, 1, Integer.MAX_VALUE);
		...
		MAGMA_MONSTER_GRUNT_OW_SPAWN_PROBABILITY = COMMON_BUILDER.comment("Over World Magma Monster Grunt Chance Probability").defineInRange("magma_monster_grunt_chance", 2000, 1, Integer.MAX_VALUE);
		...
		MAGMA_MONSTER_GRUNT_HELL_SPAWN_PROBABILITY = COMMON_BUILDER.comment("Nether Magma Monster Grunt Chance Probability").defineInRange("magma_monster_grunt_chance", 2000, 1, Integer.MAX_VALUE);
