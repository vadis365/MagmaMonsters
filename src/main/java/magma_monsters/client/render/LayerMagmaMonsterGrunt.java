...
public class LayerMagmaMonsterGrunt implements LayerRenderer<EntityMagmaMonsterGrunt> {
    ...
    private final RenderMagmaMonsterGrunt monsterRenderer;
    private final ModelMagmaMonsterGrunt monsterModel = new ModelMagmaMonsterGrunt();

    public LayerMagmaMonsterGrunt(RenderMagmaMonsterGrunt monsterRenderer) {
        this.monsterRenderer = monsterRenderer;
    }

	@Override
	public void doRenderLayer(EntityMagmaMonsterGrunt entity, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
