...
public class ModelMagmaMonster<T extends EntityMagmaMonster> extends EntityModel<T> {
    ...
    public ModelMagmaMonster() {
        textureWidth = 64;
        textureHeight = 64;
        torsoTop = new ModelPart(this, 12, 22);
        ...
        faceBottom = new ModelPart(this, 41, 6);
        ...
        rightArmBottom = new ModelPart(this, 52, 6);
        ...
        backLumpMid = new ModelPart(this, 0, 35);
        ...
        leftLegThigh = new ModelPart(this, 0, 43);
        ...
        torsoBottom = new ModelPart(this, 19, 35);
        ...
        rightLegLavaInner = new ModelPart(this, 20, 55);
        ...
        leftLegLavaBack = new ModelPart(this, 13, 54);
        ...
        rightLegLavaBack = new ModelPart(this, 13, 54);
        ...
        headMain = new ModelPart(this, 20, 10);
        ...
        rightLegShin = new ModelPart(this, 52, 53);
        ...
        leftArmLavaOutBack = new ModelPart(this, 36, 56);
        ...
        rightLegLavaFront = new ModelPart(this, 13, 54);
        ...
        leftLegLavaOuter = new ModelPart(this, 20, 55);
        ...
        backLumpBot = new ModelPart(this, 9, 35);
        ...
        leftArmLavaOutFront = new ModelPart(this, 43, 56);
        ...
        leftTuskStart = new ModelPart(this, 48, 34);
        ...
        leftLegLavaInner = new ModelPart(this, 20, 55);
        ...
        rightTuskEnd = new ModelPart(this, 56, 29);
        ...
        backLumpTop = new ModelPart(this, 0, 28);
        ...
        leftLegShin = new ModelPart(this, 0, 53);
        ...
        leftArmTop = new ModelPart(this, 0, 18);
        ...
        rightLegLavaOuter = new ModelPart(this, 20, 55);
        ...
        leftLegLavaFront = new ModelPart(this, 13, 54);
        ...
        rightArmLavaOutFront = new ModelPart(this, 43, 56);
        ...
        leftArmLavaInner = new ModelPart(this, 27, 56);
        ...
        rightArmTop = new ModelPart(this, 52, 18);
        ...
        leftArmBottom = new ModelPart(this, 0, 6);
        ...
        rightArmLavaOutBack = new ModelPart(this, 36, 56);
        ...
        leftTuskEnd = new ModelPart(this, 56, 29);
        ...
        rightTuskStart = new ModelPart(this, 48, 34);
        ...
        headCrest = new ModelPart(this, 12, 1);
