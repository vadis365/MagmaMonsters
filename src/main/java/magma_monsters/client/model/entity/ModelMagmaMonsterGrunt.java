...
@OnlyIn(Dist.CLIENT)
public class ModelMagmaMonsterGrunt<T extends EntityMagmaMonsterGrunt> extends EntityModel<T> {
	...
	public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
		ImmutableList.of(this.torsoBottom).forEach((p_228279_8_) -> {p_228279_8_.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);});
	}
